...
export const cardinal: PieceTheme = {
  ...
  b: () => (
    <svg {...svgProps}>
      ...
      />
      <ellipse className="prefix__st15" cx={25} cy={9.612} rx={1.14} ry={1.147} fill="#e6e6e6" />
      <path
  ...
  r: () => (
    <svg {...svgProps}>
      ...
      />
      <path d="M18.8 31.4h11.998M18.8 20h11.998" fill="none" stroke="#e6e6e6" strokeWidth={1.4} />
    </svg>
  ),
  k: () => (
    <svg {...svgProps}>
  ...
  N: () => (
    <svg {...svgProps}>
      ...
      <path
        ...
        strokeWidth={1.4}
      />
      <ellipse cx={21.027} cy={18.001} rx={1.242} ry={1.168} paintOrder="markers fill stroke" />
      <path
        d="M9.17 29.241s.254-.682.924-1.118"
        fill="#fff"
        stroke="#000"
  ...
  B: () => (
    <svg {...svgProps}>
      ...
      <ellipse
        ...
        filter="url(#prefix__c)"
      />
      <ellipse className="prefix__st15" cx={25} cy={9.611} rx={1.14} ry={1.147} />
      <path d="M21.333 23.266h7.333M25 19.932v6.752" fill="none" stroke="#000" strokeWidth={1.4} />
    </svg>
  ),
  Q: () => (
    <svg {...svgProps}>
